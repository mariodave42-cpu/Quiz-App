  ...
  return (
    <div className="w-full h-screen bg-[#eebc73] flex justify-center items-center ">
      ...
      <div className="w-[92%] h-[15%] bg-[#fff5d8] rounded-[50px] mb-[25px] text-center flex justify-center items-center text-[15px] font-semibold  md:p-9 lg:w-[70%] ">
        Small steps, big results — that’s how champions prepare. Take a quiz now, challenge your 
        limits, and push yourself closer to the grades you’re chasing 🎯🔥. Improvement starts with your next question.
      </div>
      ...
      <div>
        Practice transforms knowledge into confidence. Every quiz you take helps you identify weak areas, 
        reinforces what you know, and ensures you’re ready for the real exam.
      </div>
      </div>
      </div>
