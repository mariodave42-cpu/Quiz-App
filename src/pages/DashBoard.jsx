...
const navigate = useNavigate()
  ...
  navigate("/questionpage")
    ...
    <div className="flex justify-center items-center gap-[4px]"><FaTimes color="#f44336"/> Incorrect : {wrong}</div>
      ...
      <div className="w-[95%] h-[15%] mt-5  bg-[#ffffff] shadow-[rgba(0, 0, 0, 0.35) 0px 5px 15px;] rounded-xl overflow-hidden shadow-md flex items-center justify-between lg:w-[50%]">
  <div>
